...
const CustomModal = ({ width, isOpen, setIsOpen, children }) => {
    return (
        <Modal
            title={<div style={{ fontSize: '24px', textAlign: 'center'}}>Interview Creation Form</div>} // title için özelleştirilmiş font boyutu ve merkeze hizalama
