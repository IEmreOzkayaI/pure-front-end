				...
				>
					<div className={styles.explanation}>
						<div className={styles.texts}>
							<div>pure code</div>
							{user === "company" ? <div>For Companies</div> : <div>For Users</div>}
						...
						<form onSubmit={(e) => handleLogIn(e)}>
							<div className={styles.col}>
								<div className={styles.inputGroup}>
									...
									<input type='text' id='email' autoComplete='username' onChange={(e) => handleFormChange(e)} />
								</div>
							</div>
							<div className={styles.col}>
								<div className={styles.inputGroup}>
									<label htmlFor='password'>Password</label>
									<input type='password' id='password' autoComplete='new-password' onChange={(e) => handleFormChange(e)} />
								</div>
							</div>
