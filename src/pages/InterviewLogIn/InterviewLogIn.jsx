...
import { clearInterviewResultInfo } from "../../redux/toolkit/interviewResultSlice";
...
const InterviewLogIn = () => {
	...
	useEffect(() => {
		if (interviewError) {
			...
			} else if (interviewError === "Interview Result is not found") {
				console.log("Interview Result is not found");
        dispatch(clearInterviewResultInfo());
			} else {
				toast.error(
				...
				<div className={styles.grid}>
					<div className={styles.explanation}>
						<div className={styles.texts}>
							...
							<p>
								Welcome to the Pure, the best platform for your career. We are here to help you to find the best job for you. You can find the best job for you with the help of Pure.
								<br /> <br />
								This page for the candidates who want to apply for the interview. You can fill the form and apply for the interview. We will contact you as soon as possible.
								<br /> <br />
							</p>
						</div>
